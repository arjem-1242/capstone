...
import pandas as pd
from .models import Education, Employment, ResumeDocument
import pytesseract
import cv2
...
def parse_resume_text(text):
    ...
    skills = extract_skills(doc, skills_set=load_skills_from_csv(), threshold=87)
...
def extract_skills(doc, skills_set, threshold=87, max_tokens=6):
    """
