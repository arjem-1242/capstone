...
def jobseeker_services(request):
    return render(request, 'jobseeker/services.html')

def jobseeker_contact(request):
    return render(request, 'jobseeker/contact.html')

def jobseeker_service_detail_1(request):
    return render(request, 'jobseeker/service_1.html')

def jobseeker_service_detail_2(request):
    return render(request, 'jobseeker/service_2.html')

def jobseeker_service_detail_3(request):
    return render(request, 'jobseeker/service_3.html')

def jobseeker_service_detail_4(request):
    return render(request, 'jobseeker/service_4.html')

def jobseeker_service_detail_5(request):
    return render(request, 'jobseeker/service_5.html')

def jobseeker_service_detail_6(request):
    return render(request, 'jobseeker/service_6.html')

def jobseeker_faqs(request):
    return render(request, 'jobseeker/faqs.html')
...
def jobseeker_change_password(request):
    ...
    if request.method == "POST":
        form = JobSeekerChangePasswordForm(request.POST)
        if form.is_valid():
            ...
            if not request.user.check_password(old_password):
                ...
                return redirect(reverse ("jobseeker:job_seeker_profile"))
    else:
        form = JobSeekerChangePasswordForm()

    return render(request, "jobseeker/change_password.html", {"form": form})
